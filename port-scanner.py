...
ports = [20, 21, 22, 23, 25, 53, 67, 68, 80, 81, 82, 83, 88, 110, 111, 123, 135, 137, 138, 139, 143, 161, 162, 179,
         389, 443, 445, 465, 587, 636, 993, 995, 989, 990, 10250, 10255, 10257, 10259, 135, 1433, 1434, 1521, 1522,
         1529, 161, 162, 179, 443, 445, 465, 587, 6379, 6443, 7000, 7001, 7002, 7003, 7004, 7005, 8000, 8080, 8081,
         ...
         5061, 5173, 5174, 5349, 5601, 5672, 5985, 5986, 6000, 5900, 5987, 5988, 8080, 9000, 9418, 10443, 1194, 4500,
         500, 5080, 5081, 2049, 464, 3268, 3128, 8085, 8086, 8880, 4433, 50000, 50013, 199,502, 1911, 47808, 50070,
         8020]
#=======================================================================================================================

#Tentar se conectar a uma porta
def scann_port(host, port, timeout=0.5):
    try:
